# genpark-spreadsheet-data-sanitization-normalizer-skill
...
**genpark-spreadsheet-data-sanitization-normalizer-skill** is a deterministic, zero-dependency Python skill engineered for autonomous spreadsheet data sanitization, reverse CTE SQL synthesis, and executive BI analytics.

> **Executive Capability**: Tabular spreadsheet data sanitization normalizer (Livedocs / Julius)
...
result = client.sanitize_tabular_dataset()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-spreadsheet-data-sanitization-normalizer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-spreadsheet-data-sanitization-normalizer-skill/mcp_server.py"]
    }
  }
}
```
